<template>
    ...
    <RouterLink to="/Details"><img src="../images/HomePageImg/OlympicDetails.png"  class="OlympicDetails"></img></RouterLink>
    <img src="../images/HomePageImg/ChinesePride.png" class="ChinesePride"></img>
</template>
