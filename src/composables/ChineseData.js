const ChineseData = [
    {
        ...
        { name: "马龙", alias: "六边形战士", achievement: "首位集奥运会、世锦赛、世界杯、亚运会、亚锦赛、亚洲杯、巡回赛总决赛、全运会单打冠军于一身的超级全满贯男子选手", comments: "马龙的球风很正，就像他本人。是球队公认最努力最有天赋的一个运动员，是“战术大师”。", img: "../../public/source/img/fan.jpg" },
        { name: "王曼昱", alias: "鳗鱼", achievement: "国际级运动健将，中国乒乓球运动员", comments: "曼昱平时不怎么爱说话，但做事心里很有数，并且在言语当中能感觉到其远大的理想。技术上领先是一方面，很重要的是心理、思想上比同龄孩子都要成熟，很多优良的内在素质是她成功的关键。", img: "../../public/source/img/fan.jpg" },
        ...
        { name: "孙颖莎", alias: "莎莎、小豆包", achievement: "现女单世界第一、WTT大满贯赛史上首位“三冠王”", comments: "她清楚地意识到，只有熟悉每一个对手，站在场上才能不慌。她知道自己要什么，并为之不顾一切，同时她也会在比赛中总结点滴的经验，有信念、有拼劲，也有想法和策略。", img: "../../public/source/img/chen.jpg" }],
