const ChineseData = [
    ...
    {//缺王顺
        name: "游泳",
        sorts: [{ eventname: "男子100米自由泳", player: ["潘展乐"], describe: "金牌", picture: ["../../public/source/img/panzhanle.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子4×100米混合接力", player: ["徐嘉余", "覃海洋", "潘展乐","王长浩","孙佳俊"], describe: "金牌", picture: ["../../public/source/img/xujiayu.png","../../public/source/img/tanhaiyang.png","../../public/source/img/panzhanle.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子100米仰泳", player: ["徐嘉余"], describe: "银牌", picture:[ "../../public/source/img/xujiayu.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "女子100米蛙泳", player: ["唐钱婷"], describe: "银牌", picture: ["../../public/source/img/tangqianting.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男女混合4×100米混合泳接力", player: ["徐嘉余","覃海洋","张雨霏","杨浚瑄","潘展乐","唐钱婷"], describe: "银牌", picture: ["../../public/source/img/zhangyufei.png","../../public/source/img/tangqianting.png","../../public/source/img/panzhanle.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "女子100米蛙泳", player: ["杨浚瑄","程玉洁","张雨霏","吴卿风","余依婷"], describe: "铜牌", picture: ["../../public/source/img/yangjunxuan.png","../../public/source/img/chengyujie.png","../../public/source/img/zhangyufei.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "女子100米蝶泳", player: ["张雨霏"], describe: "铜牌", picture: ["../../public/source/img/zhangyufei.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "女子200米蝶泳", player: ["张雨霏"], describe: "铜牌", picture: ["../../public/source/img/zhangyufei.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "女子100米蝶泳", player: ["杨浚瑄","李冰洁","葛楚彤","柳雅欣","孔雅琪","汤慕涵"], describe: "铜牌", picture: ["../../public/source/img/yangjunxuan.png","../../public/source/img/libingjie.png","../../public/source/img/tangmuhan.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        ...
        { eventname: "女子50米自由泳", player: ["张雨霏"], describe: "铜牌", picture: ["../../public/source/img/zhangyufei.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        ...
        player: [{ name: "潘展乐", alias: "PAN Zhanle", achievement: "男子100米自由泳世界纪录和奥运会纪录保持者，2024年巴黎奥运会男子100米自由泳冠军。", comments: "潘展乐是当今泳坛不可多得的天才型运动员，在短距离和长距离项目中展现出非凡实力，这种能力在游泳选手中颇为罕见。非常有天赋，是更高等级的上升，我觉得可以说是世界第一人。", img: "../../public/source/img/panzhanle.png" },
        ...
        { name: "覃海洋", alias: "Qin Haiyang", achievement: "2024年巴黎奥运会男女混合4X100米混合泳接力亚军、男子4x100米混合泳接力冠军", comments: "覃海洋的特点是心态比较稳、不怯场，在大型比赛中基本上能够赛出自己的实力，达到预期目标。他有很多闪光点，踏实肯干、坚持不懈、百折不挠，看似慢慢悠悠，其实内心坚定，不容易受到外界干扰。", img: "../../public/source/img/tanhaiyang.png" },
        ...
        { name: "唐钱婷", alias: "蛙蛙公主", achievement: "2024年巴黎奥运会女子100米蛙泳亚军、男女混合4×100米混合泳接力亚军、女子4×100米混合泳接力季军", comments: "唐钱婷的身高很出挑，爆发力好，具有良好的心理素质。她的各方面素质也不错，能吃苦，碰到什么困难都能自己克服，性格开朗。", img: "../../public/source/img/tangqianting.png" },
        { name: "张雨霏", alias: "雨霏", achievement: "2024年巴黎奥运会女子4×100米自由泳接力季军、女子100米蝶泳季军、女子200米蝶泳季军、男女混合4×100米混合泳接力亚军、女子50米自由泳季军、女子4×100米混合泳接力季军", comments: "宁可肌肉在深夜里燃烧，不让情绪在失败中沉沦。哪吒，就是要脱胎换骨；蝶后，一定是蝶变之后，探索运动的极限，收割青春的金牌，冠军是胜者，更是逆境中崛起的人。", img: "../../public/source/img/zhangyufei.png" },
        { name: "杨浚瑄", alias: "淼淼", achievement: "2024年巴黎奥运会女子4×200米自由泳接力季军、男女4×100米混合泳接力亚军、女子4X100米混合泳接力季军", comments: "她在训练中很用心，有着很好的意志品质，最大的特点是执行力非常强。她这种爱思考、有执行力的素质，与长期坚持画画和写字对性格、心理方面的锤炼是有关系的。", img: "../../public/source/img/yangjunxuan.png" },
    ...
    {//缺丘奇冤 周亚琴
        name: "体操",
        sorts: [{ eventname: "男子吊环", player: ["刘洋"], describe: "金", picture: ["../../public/source/img/liuyang.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子双杠", player: ["邹敬园"], describe: "金", picture:[ "../../public/source/img/zoujingyuan.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "集体全能", player: ["丁欣怡","郭崎琪","郝婷","黄张嘉洋","王澜静"], describe: "金", picture: ["../../public/source/img/dingxinyi.png","../../public/source/img/guojiaqi.png","../../public/source/img/haoting.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子团体赛", player: ["张博恒","肖若腾","邹敬园","苏炜德","刘洋"], describe: "银", picture: ["../../public/source/img/zhangboheng.png","../../public/source/img/xiaoruoteng.jpg","../../public/source/img/zoujingyuan.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子全能", player: ["张博恒"], describe: "银", picture: ["../../public/source/img/zhangboheng.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子吊环", player: ["邹敬园"], describe: "银", picture: ["../../public/source/img/zoujingyuan.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        ...
        { eventname: "男子全能", player: ["肖若腾"], describe: "铜", picture: ["../../public/source/img/xiaoruoteng.jpg"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子单杠决赛", player: ["张博恒"], describe: "铜", picture: ["../../public/source/img/zhangboheng.png"], comment: "继续荣耀的脚步，不忘心中的火种" }],
    ...
    {//缺屡建林将一听图片
        name: "射击",
        sorts: [{ eventname: "混合团体10米气步枪", player: ["黄雨婷","盛李豪"], describe: "第34金", picture: ["../../public/source/img/huangyuting.png","../../public/source/img/shenglihao.png","../../public/source/img/fan.jpg"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子10米气手枪", player: ["谢瑜"], describe: "第34金", picture: ["../../public/source/img/fan.jpg","../../public/source/img/xieyu.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子10米气步枪", player: ["盛李豪"], describe: "第34金", picture:[ "../../public/source/img/shenglihao.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子50米步枪三姿", player: ["刘宇坤"], describe: "第34金", picture: ["../../public/source/img/liuyukun.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子25米手枪速射", player: ["李越宏"], describe: "第34金", picture: ["../../public/source/img/liyuehong.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "女子10米气步枪", player: ["黄雨婷"], describe: "银", picture: ["../../public/source/img/huangyuting.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子多向飞碟", player: ["齐迎"], describe: "银", picture: ["../../public/source/img/qiying.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "女子50米步枪三姿", player: ["张琼月"], describe: "铜", picture: ["../../public/source/img/zhangqiongyue.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
        { eventname: "男子25米手枪速射", player: ["王鑫杰"], describe: "铜", picture: ["../../public/source/img/wangxinjie.png"], comment: "继续荣耀的脚步，不忘心中的火种" },
